...
fun NativoxTheme(
    ...
    // We turn OFF dynamic color so your Brand Colors always show (instead of the user's wallpaper colors)
    ...
    MaterialTheme(
        ...
        typography = Typography, // Ensure Type.kt exists in the same folder
        content = content
    )
}